...
class SearchMountainCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(right: Dimension.scaleWidth(20, context), bottom: Dimension.scaleHeight(10, context), top: Dimension.scaleHeight(10, context), left: Dimension.scaleWidth(10, context)),
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(offset: Offset(0, 0), blurRadius: 4, color: Color.fromRGBO(0, 0, 0, 0.4))
          ]),
      child: Column(
