              ...
              InkWell(
                onTap: () async {
                  ...
                  if(userCredential != null){
                    ...
                    sharedPreferences.setString("name", userCredential.additionalUserInfo!.profile!['given_name'].toString());
                    sharedPreferences.setString("userImage", userCredential.user!.photoURL.toString());
